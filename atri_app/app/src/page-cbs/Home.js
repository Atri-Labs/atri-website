...
export function useNavbarLeftCb() {
	const onClick = useCallback(callbackFactory("NavbarLeft", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useNavbarCenterCb() {
	const onClick = useCallback(callbackFactory("NavbarCenter", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useNavbarRightCb() {
	const onClick = useCallback(callbackFactory("NavbarRight", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useNavbarWrapperCb() {
	const onClick = useCallback(callbackFactory("NavbarWrapper", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
